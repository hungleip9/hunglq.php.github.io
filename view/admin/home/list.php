          ...
          <div class="col-8 text-right">
            <nav class="site-navigation" role="navigation">
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block mb-0">
                ...
                <li><a href="index.php?c=home&mod=admin&act=index">Home</a></li>
        ...
        <div class="row">
          <div class="col-lg-12 mb-12">
            <div class="entry2" style="text-align: center;">
              <a href="index.php?c=home&mod=admin&act=detail&id=<?php echo $category['id']?>"><img style="width: 50%;" src="<?php echo $category['file'];?>" alt="Image" class="img-fluid rounded"></a>
              <div class="excerpt">
              ...
              <div class="post-meta align-items-center text-left clearfix">
                ...
                <a style="border-radius: 10px; margin-bottom: 20px;" href="index.php?c=home&mod=admin&act=edit&id=<?php echo $category['id']?>" class="btn btn-success">Edit</a>
